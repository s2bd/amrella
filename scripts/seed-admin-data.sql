...
-- UPDATE profiles SET role = 'admin' WHERE email = 'admin@amrella.com';
-- UPDATE profiles SET role = 'super_admin' WHERE email = 'superadmin@amrella.com';

-- Sample verified users (update with real user IDs)
-- UPDATE profiles SET is_verified = true, verification_type = 'creator' WHERE email = 'creator@example.com';
